...
export const Input = React.forwardRef<HTMLInputElement, InputProps>(
  (
    ...
    // Base classes
    const baseClasses = 'border rounded-lg bg-background-paper text-text-primary placeholder:text-text-tertiary transition-all duration-normal focus:outline-none focus:ring-2';
