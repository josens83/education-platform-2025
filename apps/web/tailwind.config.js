...
export default {
  ...
  theme: {
    extend: {
      colors: {
        // Design token based colors using CSS variables
        ...
        // Brand colors - preserved for consistency
        primary: {
          50: '#f0f9ff',
          100: '#e0f2fe',
          200: '#bae6fd',
        ...
        // Linear-style gradient colors for dark mode
        accent: {
          purple: '#a855f7',
          blue: '#3b82f6',
          cyan: '#06b6d4',
      ...
      boxShadow: {
        ...
        'smooth': '0 2px 8px -2px rgba(0, 0, 0, 0.1), 0 4px 16px -4px rgba(0, 0, 0, 0.08)',
        'smooth-lg': '0 4px 16px -2px rgba(0, 0, 0, 0.1), 0 8px 32px -4px rgba(0, 0, 0, 0.08)',
      },
      animation: {
